...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "软刀"
  # spec.authors            = { "软刀" => "ljy080829@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/软刀"
  ...
  spec.source       = { :git => "https://github.com/ruandao/KnobControl.git", :tag => "#{spec.version}" }
